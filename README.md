...
Add permissive network policy to enable anything from fncm namespace to reach to anything (TODO needed on 2024-02-05 for FNCM 5.5.12 for CASE package 1.8.0)
```bash
echo "
kind: NetworkPolicy
